                ...
                <div class="art-info-bar-frame">
                    ...
                    <div class="art-header">
                        ...
                        <div class="art-avatar">
                            <a data-fancybox="avatar" href="{{asset("frontend/assets/img/cp.jpg")}}"
                               class="art-avatar-curtain">
                                <img src="{{asset("frontend/assets/img/cp.jpg")}}" alt="avatar">
                        ...
                        <!-- avatar end -->
                        <!-- name -->
                        <h5 class="art-name mb-10">Mushfiqur Rahaman</h5>
                        <!-- post -->
                        <div class="art-sm-text">Technical Business Analyst <br>Technical Consultant</div>
                    </div>
                    <!-- info bar header end -->
                    ...
                    <div id="scrollbar2" class="art-scroll-frame">
                        ...
                        <div class="art-links-frame p-15-15">
                            ...
                            <!-- download cv button -->
                            <a href="{{asset("frontend/assets/files/cv.txt")}}" class="art-link" download>Download cv <i
                ...
                <div class="transition-fade" id="swup">
                    ...
                    <div id="scrollbar" class="art-scroll-frame">
                            ...
                            <div class="row p-60-0 p-lg-30-0 p-md-15-0">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="art-a art-banner"
                                         style="background-image: url({{asset("frontend/assets/img/bg.jpg")}})">
                                        <!-- banner back -->
                                        ...
                                        <div class="art-banner-overlay">
                                            ...
                                            <div class="art-banner-title">
                                                ...
                                                <div class="art-buttons-frame">
                                                    ...
                                                    <!-- button -->
                                                    <a href="#" class="art-link art-white-link art-w-chevron">Hire
                                                        me</a>
                                                </div>
                                            </div>
                                            <!-- main title end -->
                                            <!-- photo -->
                                            <!-- <img src="img/profile.png" class="art-banner-photo" alt="Your Name"> -->
                                        </div>
                                        <!-- banner overlay end -->
                                    </div>
                                    <!-- banner end -->
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="art-a art-service-icon-box">
                                        ...
                                        <div class="art-service-ib-content">
                                            ...
                                            <!-- text -->
                                            <div class="mb-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                Delectus esse commodi deserunt vitae, vero quasi! Veniam quaerat tenetur
                                                pariatur doloribus.
                                            </div>
                                            <!-- button -->
                                            <div class="art-buttons-frame"><a href="#"
                                                                              class="art-link art-color-link art-w-chevron">Order
                                                    now</a></div>
                                        </div>
                                        <!-- service content end -->
                                    </div>
                                                ...
                                                <div class="art-a art-testimonial">
                                                    ...
                                                    <div class="testimonial-body">
                                                        ...
                                                        <img class="art-testimonial-face"
                                                             src="{{asset("frontend/assets/img/testimonials/face-1.jpg")}}"
                                                             alt="face">
                                                        <!-- name -->
                                                        <h5>Paul Trueman</h5>
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="art-a art-testimonial">
                                                    ...
                                                    <div class="testimonial-body">
                                                        <!-- photo -->
                                                        <img class="art-testimonial-face"
                                                             src="{{asset("frontend/assets/img/testimonials/face-2.jpg")}}"
                                                             alt="face">
                                                        <!-- name -->
                                                        <h5>Paul Trueman</h5>
                                                        <div class="art-el-suptitle mb-15">Template author</div>
                                                    ...
                                                    <div class="art-testimonial-footer">
                                                        <div class="art-left-side">
                                                            ...
                                                            <ul class="art-star-rate">
                                                                ...
                                                                <li><i class="fas fa-star"></i></li>
                                                                <li><i class="fas fa-star"></i></li>
                                                                <li class="art-empty-item"><i class="fas fa-star"></i>
                                                                </li>
                                                            </ul>
                                                            <!-- star rate end -->
                                                        </div>
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="art-a art-testimonial">
                                                    ...
                                                    <div class="testimonial-body">
                                                        <!-- photo -->
                                                        <img class="art-testimonial-face"
                                                             src="{{asset("frontend/assets/img/testimonials/face-3.jpg")}}"
                                                             alt="face">
                                                        <!-- name -->
                                                        <h5>Paul Trueman</h5>
                                                        <div class="art-el-suptitle mb-15">Template author</div>
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="art-a art-testimonial">
                                                    ...
                                                    <div class="testimonial-body">
                                                        <!-- photo -->
                                                        <img class="art-testimonial-face"
                                                             src="{{asset("frontend/assets/img/testimonials/face-4.jpg")}}"
                                                             alt="face">
                                                        <!-- name -->
                                                        <h5>Paul Trueman</h5>
                                                        <div class="art-el-suptitle mb-15">Template author</div>
                                    ...
                                    <div class="art-section-title">
                                        ...
                                        <div class="art-right-frame">
                                            ...
                                            <div class="art-filter">
                                                <!-- filter link -->
                                                <a href="#" data-filter="*" class="art-link art-current">All
                                                    Categories</a>
                                                <!-- filter link -->
                                                <a href="#" data-filter=".webTemplates" class="art-link">Web
                                                    Templates</a>
                                                <!-- filter link -->
                                ...
                                <div class="art-grid art-grid-3-col art-gallery">
                                    ...
                                    <div class="art-grid-item webTemplates">
                                        ...
                                        <a data-fancybox="gallery"
                                           href="{{asset("frontend/assets/img/works/original-size/1.jpg")}}"
                                           class="art-a art-portfolio-item-frame art-horizontal">
                                            <!-- img -->
                                            <img src="{{asset("frontend/assets/img/works/thumbnail/1.jpg")}}"
                                                 alt="item">
                                            <!-- zoom icon -->
                                    ...
                                    <div class="art-grid-item logos">
                                        <!-- grid item frame -->
                                        <a data-fancybox="gallery"
                                           href="{{asset("frontend/assets/img/works/original-size/2.jpg")}}"
                                           class="art-a art-portfolio-item-frame art-vertical">
                                            <!-- img -->
                                            <img src="{{asset("frontend/assets/img/works/thumbnail/2.jpg")}}"
                                                 alt="item">
                                            <!-- zoom icon -->
                                            <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                                        </a>
                                    ...
                                    <div class="art-grid-item drawings">
                                        <!-- grid item frame -->
                                        <a data-fancybox="gallery"
                                           href="{{asset("frontend/assets/img/works/original-size/3.jpg")}}"
                                           class="art-a art-portfolio-item-frame art-square">
                                            <!-- img -->
                                            <img src="{{asset("frontend/assets/img/works/thumbnail/3.jpg")}}"
                                                 alt="item">
                                            <!-- zoom icon -->
                                            <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                                        </a>
                                    ...
                                    <div class="art-grid-item ui">
                                        <!-- grid item frame -->
                                        <a data-fancybox="gallery"
                                           href="{{asset("frontend/assets/img/works/original-size/4.jpg")}}"
                                           class="art-a art-portfolio-item-frame art-vertical">
                                            <!-- img -->
                                            <img src="{{asset("frontend/assets/img/works/thumbnail/4.jpg")}}"
                                                 alt="item">
                                            <!-- zoom icon -->
                                            <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                                        </a>
                                    ...
                                    <div class="art-grid-item webTemplates">
                                        <!-- grid item frame -->
                                        <a data-fancybox="gallery"
                                           href="{{asset("frontend/assets/img/works/original-size/5.jpg")}}"
                                           class="art-a art-portfolio-item-frame art-square">
                                            <!-- img -->
                                            <img src="{{asset("frontend/assets/img/works/thumbnail/5.jpg")}}"
                                                 alt="item">
                                            <!-- zoom icon -->
                                            <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                                        </a>
                                    ...
                                    <div class="art-grid-item logos">
                                        <!-- grid item frame -->
                                        <a data-fancybox="gallery"
                                           href="{{asset("frontend/assets/img/works/original-size/6.jpg")}}"
                                           class="art-a art-portfolio-item-frame art-vertical">
                                            <!-- img -->
                                            <img src="{{asset("frontend/assets/img/works/thumbnail/6.jpg")}}"
                                                 alt="item">
                                            <!-- zoom icon -->
                                            <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                                        </a>
                                    ...
                                    <div class="art-grid-item drawings">
                                        <!-- grid item frame -->
                                        <a data-fancybox="gallery"
                                           href="{{asset("frontend/assets/img/works/original-size/7.jpg")}}"
                                           class="art-a art-portfolio-item-frame art-square">
                                            <!-- img -->
                                            <img src="{{asset("frontend/assets/img/works/thumbnail/7.jpg")}}"
                                                 alt="item">
                                            <!-- zoom icon -->
                                            <span class="art-item-hover"><i class="fas fa-expand"></i></span>
                                        </a>
                                    ...
                                    <div class="art-timeline art-gallery" id="history">
                                        <div class="art-timeline-item">
                                            ...
                                            <div class="art-a art-timeline-content">
                                                ...
                                                <p>Dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum
                                                ...
                                                <a data-fancybox="diplome"
                                                   href="{{asset("frontend/assets/files/certificate.jpg")}}"
                                        ...
                                        <div class="art-timeline-item">
                                            ...
                                            <div class="art-a art-timeline-content">
                                                ...
                                                <div>Consectetur adipisicing elit. Iusto, optio, dolorum provident rerum
                                                    aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde?
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="art-timeline-item">
                                            ...
                                            <div class="art-a art-timeline-content">
                                                ...
                                                <p>Ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio,
                                    ...
                                    <div class="art-timeline">
                                        ...
                                        <div class="art-timeline-item">
                                            ...
                                            <div class="art-a art-timeline-content">
                                                ...
                                                <p>Adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi
                                        ...
                                        <div class="art-timeline-item">
                                            ...
                                            <div class="art-a art-timeline-content">
                                                ...
                                                <p>Consectetur adipisicing elit. Excepturi, obcaecati, quisquam id
                                                    ...
                                                    ipsam quae rerum quis. Odit, itaque, deserunt corporis vero ipsum
                                                    nisi eius odio natus ullam provident pariatur temporibus quia eos
                                                    repellat consequuntur perferendis enim amet quae quasi repudiandae
                                                    sed quod veniam
                                                    dolore
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="art-a art-blog-card">
                                                    ...
                                                    <a href="#" class="art-port-cover">
                                                        <!-- img -->
                                                        <img src="{{asset("frontend/assets/img/blog/1.jpg")}}"
                                                             alt="blog post">
                                                    </a>
                                                    <!-- post cover end -->
                                                    <!-- post description -->
                                                    <div class="art-post-description">
                                                        ...
                                                        <!-- text -->
                                                        <div class="mb-15">Lorem ipsum dolor sit amet, consectetur
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="art-a art-blog-card">
                                                    ...
                                                    <a href="#" class="art-port-cover">
                                                        <!-- img -->
                                                        <img src="{{asset("frontend/assets/img/blog/5.jpg")}}"
                                                             alt="blog post">
                                                    </a>
                                                    <!-- post cover end -->
                                                    <!-- post description -->
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="art-a art-card">
                                        ...
                                        <form id="form" class="art-contact-form">
                                            ...
                                            <div class="art-form-field">
                                                <!-- message textarea -->
                                                <textarea id="message" name="text" class="art-input"
                                            ...
                                            <div class="art-submit-frame">
                                                <button class="art-btn art-btn-md art-submit" type="submit"><span>Send message</span>
                                                </button>
                                                <!-- success -->
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-lg-3">
                                    <!-- brand -->
                                    <img class="art-brand" src="{{asset("frontend/assets/img/brands/1.png")}}"
                                         alt="brand">
                                </div>
                                <!-- col end -->
                        ...
                        <div class="container-fluid">
                            ...
                            <footer>
                                <!-- copyright -->
                                <div>© 2023 Mushfiqur Rahaman</div>
                            </footer>
                            <!-- footer end -->
...
<!-- anime js -->
<script src="{{asset("frontend/assets/js/plugins/anime.min.js")}}"></script>
<!-- swiper js -->
<script src="{{asset("frontend/assets/js/plugins/swiper.min.js")}}"></script>
<!-- progressbar js -->
<script src="{{asset("frontend/assets/js/plugins/progressbar.min.js")}}"></script>
<!-- smooth scrollbar js -->
<script src="{{asset("frontend/assets/js/plugins/smooth-scrollbar.min.js")}}"></script>
<!-- overscroll js -->
<script src="{{asset("frontend/assets/js/plugins/overscroll.min.js")}}"></script>
<!-- typing js -->
<script src={{asset("frontend/assets/js/plugins/typing.min.js")}}></script>
<!-- isotope js -->
...
<!-- swup js -->
<script src={{asset("frontend/assets/js/plugins/swup.min.js")}}></script>
